...
const defaultUsers: User[] = [
  ...
  { id: "lanana", name: "Ланана", login: "Lanana", role: "child" },
  { id: "roman",  name: "Роман",  login: "Roman",  role: "child" },
  { id: "rovan",  name: "Рован",  login: "Rovan",  role: "child" },
];

const defaultTaskTemplates: TaskTemplate[] = [
  { id: "english",    title: "Английский",   active: true, assignedUserIds: ["rodion"] },
  { id: "pe",         title: "Физкультура",  active: true, assignedUserIds: ["rodion","nani","lanana","roman","rovan"] },
  { id: "reading",    title: "Чтение",       active: true, assignedUserIds: ["nani","lanana","roman","rovan"] },
  { id: "math",       title: "Математика",   active: true, assignedUserIds: ["nani","lanana","roman","rovan"] },
];
...
const defaultDailyQuotas = [
  // Дети
  ...["nani", "lanana", "roman", "rovan"].flatMap(userId => [
